#YOUR NAME
#SE126.02: Inter. Programing using Python
...
def again(): #<---- Function header
    ...
    #Whe loop trap- ensure a user provdes a valid vaue before movng on
    while ans != "y" or answer != "n":
        ans = input("***INVALID ENTRY!***\n Would you like to enter another temperature? [y/n]: ").lower()
    return ans

def converter (f):
    '''this function is passed tempF value ('f' paramamater), converts this to TempC and then returns it to the program'''
    c = (f - 32) * (5 / 9)
...
while answer == "y":
    ...
    answer = again() #the return value of this function will replace this call as the final result for answer!
